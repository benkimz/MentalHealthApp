...
namespace MentalHealthApp.PWA.Pages.GuiltPage
{
    public class GuiltBase : ComponentBase
    {
        [Inject]
        private IJSRuntime? JSRuntime { get; set; }

        protected string Tag => "Guilt";
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            {
                videos = await videoContentRepository.GetGuiltVideos();
                StateHasChanged();
            }
        }
    }
